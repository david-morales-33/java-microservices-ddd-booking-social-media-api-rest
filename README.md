...
>API REST para una red social orientada a la reserva de citas con profesionales como tatuadores, peluqueros y otros prestadores de servicios de belleza. Desarrollada con java (Spring Boot), arquitectura de microservicios y Domain-Driven Design (DDD).
---
## 🧭 Tabla de Contenidos
